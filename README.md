<p align="center">
  <img src="https://raw.githubusercontent.com/aifa-agi/aifa/main/public/favicons/android-chrome-192x192.png" alt="AIFA Logo" width="120" height="120" style="border-radius:50%; box-shadow:0 2px 12px #00000022;">
</p>
...
<p align="center">
  ...
  <a href="https://github.com/aifa-agi/aifa-navigation-menu/stargazers" target="_blank">
    <img alt="GitHub stars" src="https://img.shields.io/github/stars/aifa-agi/aifa-navigation-menu?style=for-the-badge&logo=github">
  </a>
...
-   **🎛️ Role-Based Access Control (RBAC):** Easily configure the visibility of links and entire menu categories for different user roles (e.g., `Guest`, `Admin`, `Subscriber`).
-   **👨‍💻 Role Simulator:** A built-in tool for quickly demonstrating and testing RBAC without requiring actual authentication. Perfect for development and client presentations.
