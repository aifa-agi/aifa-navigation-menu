...
import { menuData, MenuCategory, MenuLink } from "../menu-data";
...
export default function CatchAllPage({ params }: ParamsType) {
  ...
  console.log("[CatchAllPage] usableParams:", usableParams);
  console.log("[CatchAllPage] paramArray:", paramArray);
  console.log("[CatchAllPage] current role:", role);
